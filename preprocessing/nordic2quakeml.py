"""
Convert SEISAN Nordic format (hyp.out) to QuakeML format.

This script reads SEISAN hyp.out file and converts it to QuakeML format
suitable for HypoDD processing.
...
Input
-----
    hyp.out : SEISAN Nordic format file with event locations and picks

Output
------
    hypoDD_quakeml.xml : QuakeML format file
"""
import re
